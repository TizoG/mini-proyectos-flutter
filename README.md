...
| 2 | [Generador de frases](./MiniProyecto_2_Generador_Frases/) | Frase aleatoria al pulsar un botón | Listas, botones y aleatoriedad | Primera versión funcional · revisión visual pendiente |
| 3 | [Selector de estado de ánimo](./MiniProyecto_3_Selector_Estado_Animo/) | Selección de una mascota con mensaje asociado | `enum`, `setState`, assets y comunicación entre widgets | Base Flutter Android y diseño listos · UI pendiente |
